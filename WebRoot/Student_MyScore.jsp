	...
	<body>
		...
		<div id="sidebar">
			...
			<ul>
				...
				<li class="active"><a href="finish/search2"><i class="icon icon-th"></i> <span>我的成绩</span></a></li>
					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
					            ...
					            <tr>
					                   <td><%=s %></td>
					                    <td><a href="finish/search_finish2?finishid=${finish.finishid}">${finish.examtitle}</a></td>
					               <td><input type="text" value="${finish.totalscore}" style="border:0px; color:red;"/></td>
					            </tr>
					                 </c:forEach>
