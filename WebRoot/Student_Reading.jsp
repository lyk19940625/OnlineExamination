			...
			<ul>
				...
				<li class="submenu active open">
					...
					<ul>
						...
						<li class="active"><a href="student_reading/query">阅读题</a></li>
					</ul>
				</li>
					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
					            ...
					            <tr>
					                   <td><%=s %></td>
					       	       <td><a onclick="javascript:alert('${reading.ranswer}');">${reading.rtitle}</a></td>
					       	        <td><input type="hidden" name="rtitle" value="${reading.rtitle}"/></td>
					               <td><textarea name="Ranswer"></textarea></td>
					                <td><input type="hidden" name="answer" value="${reading.ranswer}"/></td>
					              <td>
					                     <a href="errorquestion/save_reading?rid=${reading.rid}" onclick="checkform()">加入错题库</a>
					                 </td>
					            </tr>
					                 </c:forEach>
