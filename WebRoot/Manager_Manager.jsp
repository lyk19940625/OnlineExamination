...
<html lang="en">
	...
	<body>
		...
		<div id="sidebar">
			<a href="#" class="visible-phone"><i class="icon icon-th-list"></i> 管理员</a>
			<ul>
				...
				<li class="submenu active open">
					...
					<ul>
			            ...
			            <li class="active"><a href="manager/query_manager">管理员</a></li>
					</ul>
				</li>
						...
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
							 <form action="manager_student" method="post"> 
					            ...
					            <tr>
					             <td><c:out value="${manager.uname}"/></td>
					               <td><c:out value="${manager.account}"/></td>
					                 <td><c:out value="${manager.password}"/></td>
					                   <td><c:out value="${manager.usex}"/></td>
					                     <td><c:out value="${manager.uclass}"/></td>
					                      <td><c:out value="${manager.utype}"/></td>
