	...
	<body>
		...
		<div id="sidebar">
			...
			<ul>
				...
				</li>				<li><a href="Teacher_Exam.jsp"><i class="icon icon-tint"></i> <span>组卷</span></a></li>
					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
					            ...
					            <tr>
					                   <td><%=s %></td>
					               <td><a href="finish/search_finish?finishid=${finish.finishid}">${finish.examtitle}</a></td>
					                <td><c:out value="${finish.uname}"/></td>
					                       <td><input type="text" value="${finish.state}" style="border:0px; color:red;"/></td>
					            </tr>
					                 </c:forEach>
