...
<html lang="en">
	...
	<body>
		...
		<div id="sidebar">
			<a href="#" class="visible-phone"><i class="icon icon-pencil"></i> 错题解析</a>
			<ul>
				...
				<li  class="active"><a href="errorquestion/query"><i class="icon icon-th-list"></i> <span>错题解析</span></a></li>
					</div>
							...
							<div class="widget-content nopadding">
					            ...
					            <tr>
					             ...
					             <td><c:out value="${choice.ctitle}"/></td>
					               <td><c:out value="${choice.choicea}"/></td>
					                 <td><c:out value="${choice.choiceb}"/></td>
					                   <td><c:out value="${choice.choicec}"/></td>
					                      <td><c:out value="${choice.choiced}"/></td>
	                                  <td><c:out value="${choice.answer}"/></td>
							...
							<div class="widget-content nopadding">
					            ...
					            <tr>
					             ...
					             <td><c:out value="${blank.btitle}"/></td>
					              <td><c:out value="${blank.answer}"/></td>
						...
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
					            ...
					            <tr>
					             ...
					             <td><c:out value="${reading.answer}"/></td>
