			...
			<ul>
				...
				<li class="submenu active open">
					...
					<ul>
						...
						<li class="active"><a href="Teacher_Blank.jsp">填空题</a></li>
				...
				<div class="row-fluid">
							...
							<div class="widget-title">
								<span class="icon">
									...
									<h5>编写填空题</h5>
									  ...
									  <form action="teacher_blank/save" method="post" class="form-horizontal" />
					...
					<div class="control-group">
									...
									<div class="control-group">
										...
										<div class="controls">
									    <td valign="top"><textarea name="Btitle"></textarea></td> 
										</div>
									</div>
							<div class="control-group">
										<label class="control-label">编写答案</label>
										<div class="controls">
									    <td valign="top"><textarea name="Banswer"></textarea></td> 
										</div>
									</div>
