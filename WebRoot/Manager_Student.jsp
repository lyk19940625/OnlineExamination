...
<html lang="en">
	...
	<body>
		...
		<div id="sidebar">
			<a href="#" class="visible-phone"><i class="icon icon-th-list"></i> 学生</a>
			<ul>
				...
				<li class="submenu active open">
					...
					<ul>
						<li class="active"><a href="manager/query_student">学生</a></li>
							 ...
							 <form action="manager_student" method="post"> 
					            ...
					            <tr>
					             <td><c:out value="${student.uname}"/></td>
					               <td><c:out value="${student.account}"/></td>
					                 <td><c:out value="${student.password}"/></td>
					                   <td><c:out value="${student.usex}"/></td>
					                     <td><c:out value="${student.uclass}"/></td>
					                      <td><c:out value="${student.utype}"/></td>
					                        <td><a href="Manager_Save.jsp">增加</a></td>
					                           <td><a href="manager/deleteS?uid=${student.uid}">删除</a></td>
