...
<html lang="en">
	...
	<body>
		...
		<div id="sidebar">
			<a href="#" class="visible-phone"><i class="icon icon-pencil"></i> 知识点</a>
			<ul>
				...
				<li class="active"><a href="point/query"><i class="icon icon-tint"></i> <span>知识点</span></a></li>
							...
							<div class="widget-content nopadding">
					            ...
					            <tr>
					             <td><c:out value="${point.point}"/></td>
		                           <td><c:out value="${point.pointname}"/></td>  
		                                <td><c:out value="${point.centre}"/></td>
		                                   <td><a href="student_choice/query">查看选择题</a></td>
		                                    <td><a href="student_blank/query">查看填空题</a></td>
		                                     <td><a href="student_reading/query">查看阅读题</a></td>
		                                      <td><a href="point/queryall">查看全部</a></td>
					            </tr>
					                 </c:forEach>
