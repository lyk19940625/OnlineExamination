...
function checkform(){
	...
	<body>
		...
		<div id="sidebar">
			<a href="#" class="visible-phone"><i class="icon icon-th-list"></i> 选择题</a>
			<ul>
				...
				<li class="submenu active open">
					...
					<ul>
						<li class="active"><a href="Teacher_Choice.jsp">选择题</a></li>
				...
				<div class="row-fluid">
							...
							<div class="widget-title">
								<span class="icon">
									...
									<h5>编写选择题</h5>
									  ...
									  <form action="teacher_choice/save" method="post" class="form-horizontal" />
					            ...
					            <tr>
	                                ...
	                                <td valign="top"><label>A<input type="checkbox" name="Canswer" value="A"id=Canswer/> B<input type="checkbox" name="Canswer" value="B"id=Canswer/>C<input type="checkbox" name="Canswer" value="C"id=Canswer/>D<input type="checkbox" name="Canswer" value="D"id=Canswer/></label></td> 
					...
					<div class="control-group">
									...
									<div class="control-group">
										...
										<div class="controls">
									    <td valign="top"><textarea name="Ctitle"></textarea></td> 
										</div>
									</div>
					            ...
					            <tr>
	                                <td valign="top"><input type="text" name="A"/></td> 
	                                <td valign="top"><input type="text" name="B"/></td> 
	                                <td valign="top"><input type="text" name="C"/></td>
	                                <td valign="top"><input type="text" name="D"/></td>
