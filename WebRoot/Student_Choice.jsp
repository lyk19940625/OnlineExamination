		...
		<div id="sidebar">
			...
			<ul>
				...
				<li class="submenu active open">
					...
					<ul>
						<li class="active"><a href="student_choice/query">选择题</a></li>
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="widget-box">
						  ...
						  <!-- 	 <form action="errorquestion/save_choice" method="post"  > -->
					            ...
					            <tr>
					                <td><%=s %></td>
					                 <td><a onclick="javascript:alert('${choice.canswer}');">${choice.ctitle}</a></td>
	                                ...
	                                <td valign="top"><input type="radio" name="${choice.cid}" value="D">D、${choice.d}</td>
					                 ...
					                 <td>
					                     <a href="errorquestion/save_choice?cid=${choice.cid}" onclick="checkform()">加入错题库</a>
					                 </td>
